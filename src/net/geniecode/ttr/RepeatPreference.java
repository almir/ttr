...
public class RepeatPreference extends ListPreference {
	...
	private Schedule.DaysOfWeek mDaysOfWeek = new Schedule.DaysOfWeek(0);
	// New value that will be set if a positive result comes back from the
	// dialog.
	private Schedule.DaysOfWeek mNewDaysOfWeek = new Schedule.DaysOfWeek(0);
	...
	public void setDaysOfWeek(Schedule.DaysOfWeek dow) {
		mDaysOfWeek.set(dow);
		mNewDaysOfWeek.set(dow);
		setSummary(dow.toString(getContext(), true));
	}

	public Schedule.DaysOfWeek getDaysOfWeek() {
		return mDaysOfWeek;
	}
}
